...
hi Visual  guifg=#0a0006 guibg=#f1e0ff gui=none
"hi Visual ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Cursor ctermfg=232 ctermbg=231 cterm=NONE guifg=#0a0006 guibg=#f1e0ff gui=NONE
"guifg=black guibg=green
hi nCursor guifg=white guibg=white
